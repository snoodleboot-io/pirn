...
class AffineProjectionFilter(Knot):
    ...
    # Tikhonov regularisation added to the Gram matrix before inversion.
    _gram_regularisation: ClassVar[float] = 1e-6
    ...
    def _apf(
        ...
        for sample_index in range(start, n_samples):
            ...
            gram = (
                ...
                + AffineProjectionFilter._gram_regularisation * np.eye(projection_order)
            )

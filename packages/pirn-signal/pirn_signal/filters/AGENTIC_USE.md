...
- **Resampling inside a filter knot.** Filters preserve sample rate. If you need a lower rate, run `PolyphaseDecimator` (which integrates anti-aliasing) or route through `pirn_signal.resampling` afterward.

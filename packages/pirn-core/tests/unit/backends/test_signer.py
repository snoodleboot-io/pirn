"""Complementary Signer tests (signing path covered in test_data_store_signing.py).
...
class TestSignerKeyIsolation(unittest.TestCase):
    ...
    def test_different_keys_produce_different_signatures(self) -> None:
        s1 = Signer(b"key-one-32-bytes-padding-aaaaaaa")
        s2 = Signer(b"key-two-32-bytes-padding-bbbbbbb")
    ...
    def test_signed_payload_longer_than_original(self) -> None:
        signer = Signer(b"key-32-bytes-padding-xxxxxxxxxxx")
        payload = b"hello"

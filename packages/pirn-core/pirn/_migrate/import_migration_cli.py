...
class ImportMigrationCli:
    """Implementation of the ``pirn-migrate-imports`` console script."""
    ...
    def main(argv: list[str] | None = None) -> int:
        ...
        files = ImportMigrationCli._collect_py_files(args.paths)
        changed: list[Path] = []
...
if __name__ == "__main__":
    sys.exit(ImportMigrationCli.main())

"""``MessageBrokerConnection`` — pydantic-opaque wrapper for a :class:`~pirn.connectors.message_broker.MessageBroker`.

A :class:`~pirn.connectors.message_broker.MessageBroker` is a live,

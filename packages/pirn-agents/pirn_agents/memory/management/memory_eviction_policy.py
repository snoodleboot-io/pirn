...
:class:`~pirn_agents.memory.management.memory_record.MemoryRecord` (the candidate
set the caller lists out of the store — the
:class:`~pirn_agents.memory.stores.memory_store.MemoryStore` interface itself is left unchanged)

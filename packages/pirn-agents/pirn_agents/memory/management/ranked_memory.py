...
The output unit of :class:`~pirn_agents.memory.management.ranked_recall.RankedRecall`:
the recalled :class:`~pirn_agents.memory.management.memory_record.MemoryRecord`, its

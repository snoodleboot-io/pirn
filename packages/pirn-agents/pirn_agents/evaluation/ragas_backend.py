...
import is deferred through :meth:`~pirn.core.optional_dependency.OptionalDependency.require` so ``import
...
class RagasBackend:
    ...
    def load() -> ModuleType:
        ...
        """
        return OptionalDependency.require("ragas", extra="ragas", package="pirn-agents")

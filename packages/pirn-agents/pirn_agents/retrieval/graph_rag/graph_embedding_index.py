...
F4 :class:`~pirn_agents.retrieval.embeddings.embedding_provider.EmbeddingProvider` and stores
the resulting vectors alongside the graph in a
:class:`~pirn_agents.retrieval.vector_stores.vector_memory_store.VectorMemoryStore` (the
...
:class:`~pirn_agents.retrieval.graph_rag.node_embedding_index.NodeEmbeddingIndex` base.
"""

...
:class:`~pirn_agents.retrieval.vector_stores.vector_backend_client.VectorBackendClient`:
by default the store lazily builds a
:class:`~pirn_agents.retrieval.vector_stores.chroma_backend_client.ChromaBackendClient`
...
class ChromaMemoryStore(VectorMemoryStore):
    ...
    async def _get_client(self) -> VectorBackendClient:
        ...
        if self._client is None:
            from pirn_agents.retrieval.vector_stores.chroma_backend_client import (
                ChromaBackendClient,
            )

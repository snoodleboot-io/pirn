...
Implements :class:`~pirn_agents.retrieval.vector_stores.vector_backend_client.VectorBackendClient`
...
class ChromaBackendClient(VectorBackendClient):
    ...
    def _get_collection(self) -> Any:
        ...
        if self._collection is None:
            chromadb = OptionalDependency.require("chromadb", extra="chroma", package="pirn-agents")

...
behind a :class:`~pirn_agents.retrieval.vector_stores.vector_backend_client.VectorBackendClient`:
by default the store lazily builds a
:class:`~pirn_agents.retrieval.vector_stores.qdrant_backend_client.QdrantBackendClient`
...
class QdrantMemoryStore(VectorMemoryStore):
    ...
    async def _get_client(self) -> VectorBackendClient:
        ...
        if self._client is None:
            from pirn_agents.retrieval.vector_stores.qdrant_backend_client import (
                QdrantBackendClient,
            )

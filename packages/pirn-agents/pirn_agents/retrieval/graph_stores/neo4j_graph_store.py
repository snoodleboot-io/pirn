...
:class:`~pirn_agents.retrieval.graph_stores.graph_backend_client.GraphBackendClient`: by
default the store lazily builds a
:class:`~pirn_agents.retrieval.graph_stores.neo4j_backend_client.Neo4jBackendClient` (which
...
from pirn_agents.retrieval.graph_stores.backend_graph_store import BackendGraphStore

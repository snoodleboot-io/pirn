...
:class:`~pirn_agents.retrieval.graph_stores.graph_store.GraphStore` adapters do not call
...
hash. Model on the sibling :class:`~pirn_agents.retrieval.graph_stores.graph_store.GraphStore`.

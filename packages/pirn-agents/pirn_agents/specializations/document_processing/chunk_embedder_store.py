...
:class:`~pirn_agents.specializations.document_processing.chunk_store_write.ChunkStoreWrite`
...
from pirn_agents.specializations.document_processing.chunk_store_write import (
    ChunkStoreWrite,
)

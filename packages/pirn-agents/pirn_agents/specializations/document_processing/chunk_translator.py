...
sequential loop: one :class:`~pirn_agents.specializations.document_processing.chunk_translation.ChunkTranslation`
...
from pirn_agents.specializations.document_processing.chunk_translation import (
    ChunkTranslation,
)

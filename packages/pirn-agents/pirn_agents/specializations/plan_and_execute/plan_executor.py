...
(:class:`~pirn_agents.specializations.plan_and_execute._plan_step_loop.PlanStepLoop`)
...
Algorithm:
    ...
    2. Seed a :class:`~pirn_agents.specializations.plan_and_execute._plan_step_state.PlanStepState`
       from ``plan.steps`` and build the iteration loop.
    3. Wire :class:`~pirn_agents.specializations.plan_and_execute._plan_execution_result.PlanExecutionResult`
...
from pirn_agents.specializations.plan_and_execute._plan_step_loop import PlanStepLoop

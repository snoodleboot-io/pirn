...
Algorithm:
    ...
    3. Otherwise the sink is a
       :class:`~pirn_agents.specializations.rag._fallback_document.FallbackDocument`,
...
from pirn_agents.specializations.rag._fallback_document import FallbackDocument

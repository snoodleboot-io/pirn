...
Algorithm:
    ...
    2. Drive the rounds with a
       :class:`~pirn_agents.specializations.rag.flare_loop.FlareLoop`
    ...
    3. Extract the assembled answer as an :class:`AgentResponse` with
       :class:`~pirn_agents.specializations.rag.flare_result_extractor.FlareResultExtractor`.
...
from pirn_agents.specializations.rag.flare_result_extractor import FlareResultExtractor

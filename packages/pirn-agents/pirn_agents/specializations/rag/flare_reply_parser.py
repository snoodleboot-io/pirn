...
Shared by :class:`~pirn_agents.specializations.rag.needs_retrieval_check.NeedsRetrievalCheck`
and :class:`~pirn_agents.specializations.rag.flare_sentence_extractor.FlareSentenceExtractor`

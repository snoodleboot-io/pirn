...
backend, imported here lazily through :meth:`~pirn.core.optional_dependency.OptionalDependency.require` so
...
class GrammarBackend:
    ...
    def compile(constraint: Mapping[str, Any]) -> dict[str, Any]:
        ...
        """
        module = OptionalDependency.require("outlines", extra="grammar", package="pirn-agents")
        return {

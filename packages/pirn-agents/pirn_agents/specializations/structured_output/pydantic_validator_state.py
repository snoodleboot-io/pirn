...
class PydanticValidatorState(PirnOpaqueValue):
    ...
    Attributes:
        ...
        schema: The field names an attempt must produce, derived from
            ``model_class``.
        model_class: The model every attempt's output is validated against.

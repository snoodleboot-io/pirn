"""``JsonExtractorAttempt`` — internal helper Knot for :class:`JsonExtractorPipeline`.
...
class JsonExtractorAttempt(Knot):
    ...
    _system_prompt: ClassVar[PromptBinding] = PromptBinding(
        name="specializations.structured_output.json_extractor_attempt.system_prompt",
        default=(
    ...
    _retry_instruction: ClassVar[PromptBinding] = PromptBinding(
        name=("specializations.structured_output.json_extractor_attempt.retry_instruction"),
        default=(

"""``_ReflexionResultExtractor`` — final loop state to the public :class:`ReflexionResult`.
...
class _ReflexionResultExtractor(Knot):
    ...
    async def process(self, state: _ReflexionState, **_: Any) -> ReflexionResult:

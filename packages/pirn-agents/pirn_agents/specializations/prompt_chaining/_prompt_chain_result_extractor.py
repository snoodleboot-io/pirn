"""``PromptChainResultExtractor`` — surface the chain's final :class:`PromptChainResult`.
...
class PromptChainResultExtractor(Knot):
    ...
    async def process(self, state: PromptChainState, **_: Any) -> PromptChainResult:

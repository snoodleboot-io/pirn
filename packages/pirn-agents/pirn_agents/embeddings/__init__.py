"""Concrete :class:`~pirn_agents.embeddings.embedding_provider.EmbeddingProvider` implementations.
...
imported at the point of use via :func:`pirn_agents._internal._require._require`.
"""

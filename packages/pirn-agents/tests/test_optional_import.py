"""Tests for the shared ``OptionalImport.require`` lazy-import helper."""
...
class TestRequire(unittest.TestCase):
    def test_returns_module_when_present(self) -> None:
        ...
        module = OptionalImport.require("web", "json")
    ...
    def test_missing_backend_raises_friendly_importerror(self) -> None:
        ...
        with self.assertRaises(ImportError) as ctx:
            OptionalImport.require("vector", "a_module_that_does_not_exist_xyz")

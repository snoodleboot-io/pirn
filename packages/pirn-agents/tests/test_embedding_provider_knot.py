...
The vended type is :class:`pirn_agents.retrieval.embeddings.embedding_provider.EmbeddingProvider`
...
from pirn_agents.retrieval.embeddings.knots.embedding_provider_knot import EmbeddingProviderKnot

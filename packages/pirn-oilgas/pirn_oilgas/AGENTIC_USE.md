...
The domain is organised as seven independent sub-packages under `pirn_oilgas/`:
...
```python
from pirn_oilgas.workflows.wellbore_petrophysics_workflow import WellborePetrophysicsWorkflow
```

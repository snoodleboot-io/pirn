...
from pirn_data.specializations.quality.schema_evolution_detector import (
...
async def _make_pool() -> SqlitePool:
    ...
    await p.execute("CREATE TABLE orders (id INTEGER PRIMARY KEY, amount REAL NOT NULL)")
    return p

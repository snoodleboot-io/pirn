...
from pirn_data.specializations.quality.statistical_profiler import (
    StatisticalProfiler,
)
...
async def _make_pool() -> SqlitePool:
    ...
    await p.execute("CREATE TABLE metrics (  id INTEGER PRIMARY KEY,  score REAL,  category TEXT)")

"""``ScdType7Queries`` — parameterised SQL for the SCD Type 7 (history rows plus surrogate key) merge.

Shared by :class:`ScdType7` and :class:`ScdType7MergeKnot`, which issue
...
class ScdType7Queries:
    """Static SQL builders for the SCD Type 7 (history rows plus surrogate key) merge."""

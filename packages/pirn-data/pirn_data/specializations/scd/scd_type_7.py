...
class ScdType7(PoolMergeKnot):
    ...
    async def process(
        ...
        **_: Any,
        ...
        PoolValidator.validate_pools("ScdType7", source_pool=source_pool, target_pool=target_pool)
        PoolValidator.validate_non_empty_string("ScdType7", "source_query", source_query)

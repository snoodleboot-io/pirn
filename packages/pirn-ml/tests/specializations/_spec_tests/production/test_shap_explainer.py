...
from pirn_ml.specializations.production.shap_explainer import SHAPExplainer
...
def _fixtures():
    ...
    model = ModelManifest(model_id="m1", algorithm="rf", feature_names=("a", "b"), target_name="y")
    return model, split

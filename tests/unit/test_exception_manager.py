...
def test_report_returns_all_in_order():
    em = ExceptionManager(run_id="r1")
...
def test_rebindable_exception_carries_original_type_and_traceback():
...
def test_ordinary_exception_uses_its_own_type_and_traceback():

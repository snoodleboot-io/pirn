...
def test_type_adapter_is_cached_per_type() -> None:
...
def test_primitives_skip_type_adapter_cache() -> None:
...
def test_pydantic_basemodel_skips_type_adapter_cache() -> None:

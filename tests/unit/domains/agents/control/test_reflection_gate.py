"""Unit tests for :class:`ReflectionGate`."""
...
from pirn.domains.agents.control.reflection_gate import ReflectionGate
...
class TestProcess:
    async def test_yes_means_iterate(self) -> None:
        ...
        with Tapestry() as t:
            ...
            ReflectionGate(response=r, llm=llm, _config=KnotConfig(id="g"))

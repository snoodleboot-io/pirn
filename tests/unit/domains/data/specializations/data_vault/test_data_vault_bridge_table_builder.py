...
class TestConstruction(unittest.IsolatedAsyncioTestCase):
    ...
    def test_rejects_empty_hub_configs(self) -> None:
    ...
    def test_rejects_hub_config_missing_required_key(self) -> None:
        vault_pool = self.vault_pool
    ...
    def test_rejects_invalid_link_table(self) -> None:
        vault_pool = self.vault_pool
    ...
    def test_rejects_empty_link_table(self) -> None:
        vault_pool = self.vault_pool

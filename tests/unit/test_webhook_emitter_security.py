...
@pytest.mark.asyncio
async def test_default_verify_true_passed_to_httpx() -> None:
...
@pytest.mark.asyncio
async def test_custom_ca_bundle_path_passed_as_verify() -> None:
...
@pytest.mark.asyncio
async def test_ssl_context_passed_as_verify_to_httpx() -> None:
...
def test_private_ip_raises_when_block_private_ips_true() -> None:
...
def test_loopback_raises_when_block_private_ips_true() -> None:
...
def test_private_ip_allowed_when_block_private_ips_false() -> None:
...
def test_public_url_always_allowed() -> None:

...
def test_canonical_hook_drives_hash():
...
def test_pydantic_schema_fallback_avoids_unhashable_marker():
...
def test_canonical_hook_takes_precedence_over_pydantic_schema():
...
def test_data_batch_content_hash_stable():

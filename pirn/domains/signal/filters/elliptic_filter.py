...
Algorithm:
    1. Receive the input signal payload, order, passband_ripple_db,
...
class EllipticFilter(Knot):
    ...
    async def process(
        ...
        **_: Any,
        ...
        Args:
            signal: Signal payload to filter with the sharpest achievable transition band.
        ...
        Returns:
            SignalPayload filtered by the configured Cauer / elliptic IIR.

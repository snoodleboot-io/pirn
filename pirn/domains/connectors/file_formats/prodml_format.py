...
_PRODML_NS = "http://www.prodml.org/schemas/1series"
...
class ProdmlFormat(BatchFileFormat):
    ...
    def _load_defusedxml() -> Any:
        try:
            ...
            raise ImportError(
                "ProdmlFormat requires defusedxml. Install with "
    ...
    def _load_lxml() -> Any:
        try:
            ...
            raise ImportError(
                "ProdmlFormat requires lxml. Install with "
                "`pip install pirn[oilgas]`."
            ) from exc
        return etree
